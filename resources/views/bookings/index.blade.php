...
<div class="container-fluid px-0">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title"><i class="bi bi-calendar-check-fill me-2" style="color: var(--info)"></i>Quản lý Đặt bàn</h1>
                                    ...
                                    <div class="d-flex justify-content-end gap-1">
                                        ...
                                        @if($booking->status === 'PENDING')
                                            <form action="{{ route('bookings.confirm', $booking->id) }}" method="POST" class="m-0">
                                                @csrf @method('PATCH')
                                                <button type="submit" class="btn btn-success btn-sm" title="Xác nhận đặt bàn">
                                        ...
                                        @if($booking->status === 'PENDING' || $booking->status === 'CONFIRMED')
                                            <form action="{{ route('bookings.cancel', $booking->id) }}" method="POST" class="m-0"
                                                ...
                                                @csrf @method('PATCH')
                                                <button type="submit" class="btn btn-outline-danger btn-sm" title="Hủy đặt bàn">
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <h5>Không có lịch đặt bàn nào</h5>
                                        <p>Thử thay đổi bộ lọc hoặc <a href="{{ route('bookings.create') }}" style="color: var(--primary)">tạo lịch đặt bàn mới</a>.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
