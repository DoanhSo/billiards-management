            ...
            <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data" class="p-3 row g-3">
                ...
                <div class="col-12">
                    <div class="alert alert-info d-flex align-items-center gap-2 mb-0" style="font-size: 13px;">
                        ...
                        <span>Tài khoản này sẽ được tự động gán vai trò <strong>Khách hàng</strong>.</span>
                    </div>
                </div>

                <div class="col-12 mt-4 d-flex gap-2">
                    <x-button type="submit" variant="primary" icon="person-plus">Tạo khách hàng</x-button>
